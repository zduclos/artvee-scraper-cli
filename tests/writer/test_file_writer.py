...
from artvee_scraper_cli.writer.file_writer import JsonFileWriter, MultiFileWriter
...
def test_json_file_writer_sort_keys():
    ...
    try:
        ...
        assert (
            in_memory_file.getvalue()
            == '{"artist": "Jacoba van Heemskerck", "category": "Abstract", "date": "1915", "image": {"file_size": 2.62, "file_size_unit": "MB", "format_name": "jpg", "height": 1527, "raw": "yv66vg==", "source_url": "https://mdl.artvee.com/sdl/100286absdl.jpg", "width": 800}, "origin": "Dutch, 1876 - 1923", "resource": "composition-no-23", "title": "Composition no. 23", "url": "https://artvee.com/dl/composition-no-23/"}'
        )
